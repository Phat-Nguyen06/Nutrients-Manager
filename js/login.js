...
document.querySelector("form").addEventListener("submit", function (e) {
  ...
  if (!email.includes("@") || (!email.endsWith(".com") && !email.endsWith(".vn"))) {
    Toastify({
      text: `<i class="fa-solid fa-triangle-exclamation"></i> <strong> Email không đúng định dạng!</strong>`,
      duration: 4000,
      gravity: "top",
      position: "center",
      close: true,
  ...
  if (password.length < 8) {
    Toastify({
      text: `<i class="fa-solid fa-triangle-exclamation"></i> <strong> Mật khẩu phải có ít nhất 8 ký tự!</strong>`,
      duration: 4000,
      gravity: "top",
      position: "center",
      close: true,
